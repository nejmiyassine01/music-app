    ...
    <section class="w-full mb-8 py-14 text-center text-white relative">
      ...
      <div class="container mx-auto flex items-center">
        ...
        <div class="z-50 text-left ml-8">
          ...
          <div>{{ song.genre }}</div>
          <div class="song-price">{{ $n(1, 'currency', 'fr') }}</div>
        </div>
      </div>
    </section>
      ...
      >
        ...
        <div class="p-6">
          ...
          >
            ...
            <button
              type="submit"
              class="mt-4 py-1.5 px-3 rounded text-white bg-green-600"
...
export default {
  ...
  data() {
    return {
      ...
      comment_alert_msg: 'Please wait! Your comment is being submited.',
      comments: [],
      sort: '1',
    };
  },
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.comment_alert_msg = 'Please wait! Your comment is being submited.';
